      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <p className="text-gray-600 text-sm mb-2">Total Spent This Month</p>
            <p className="text-3xl font-bold text-gray-900">${totalSpent.toFixed(2)}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <p className="text-gray-600 text-sm mb-2">Monthly Income</p>
            <p className="text-3xl font-bold text-gray-900">${monthlyIncome.toFixed(2)}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <p className="text-gray-600 text-sm mb-2">Savings (Goal: ${savingsGoal})</p>
            <p className={`text-3xl font-bold ${monthlyIncome - totalSpent < 0 ? 'text-red-600' : 'text-green-600'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          {/* Budget vs Actual */}
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Budget vs Actual Spending</h2>
            {budgetData.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
        ...
        {/* Spending Trend */}
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Spending Trend (Last 5 Months)</h2>
          {trendData.length > 0 ? (
            <ResponsiveContainer width="100%" height={300}>
